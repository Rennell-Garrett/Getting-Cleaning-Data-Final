...
test.dir = "/Users/rennellgarrett/getting&cleaning/download_data/UCI HAR Dataset/test/Inertial Signals"
test.list = list.files(test.dir, full.names = T)
test_list_names = list.files(test.dir, full.names = F)

train.dir = "/Users/rennellgarrett/getting&cleaning/download_data/UCI HAR Dataset/train"
train.list = list.files(train.dir, full.names = T)

train.dir2 = "/Users/rennellgarrett/getting&cleaning/download_data/UCI HAR Dataset/train/Inertial Signals"
